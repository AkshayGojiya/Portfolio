...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/akshaygojiya/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@akshaygojiya",
    icon: Instagram,
    url: "https://www.instagram.com/akshaygojiya/",
    color: "#E4405F",
  ...
  // },
  {
    ...
    subText: "@AkshayGojiya",
    icon: Github,
    url: "https://github.com/akshaygojiya",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [linkedIn, instagram, github] = otherLinks;

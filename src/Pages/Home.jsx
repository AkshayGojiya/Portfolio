...
const WORDS = ["Competitive Programmer", "Exploring the Mind of Machines", "ML & AI Enthusiast", "Teaching Machines to Think, Learn, and Improve"];
const TECH_STACK = ["Flutter", "C++", "Python", "JavaScript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/akshaygojiya" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/akshaygojiya" },
  { icon: Instagram, link: "https://www.instagram.com/akshaygojiya/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Innovative, Functional, and User-Friendly Mobile Applications with Flutter for Seamless Digital Solutions.
                </p>
